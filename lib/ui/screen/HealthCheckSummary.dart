        ...
        children: [
          SingleChildScrollView(
            padding: const EdgeInsets.only(
              ...
              top: 20,
              bottom:
                  100, // Added bottom padding to prevent content from being hidden behind the button
            ),
            child: Column(
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    color: Color(
                      0xFFF6F6F6,
                    ), // Example: light orange background
                  ...
                  child: ListView(
                    ...
                    children: [
                      if (inputData != null) ...[
                        ...
                        Expanded(
                          child: _buildSymptomCard('Hypertension', 'N/A'),
                        ),
                        SizedBox(width: 12),
                        Expanded(
                          child: _buildSymptomCard('Heart Disease', 'N/A'),
                        ),
                        SizedBox(width: 12),
                        Expanded(
          ...
          Positioned(
            ...
            child: Center(
              child: CustomButton(
                ...
                style: Styles.textStyle18.copyWith(color: AppColor.kBlackColor),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const CheckSymptomsPageView(),
                    ),
                  );
                },
