...
// تغيير من StatelessWidget إلى StatefulWidget لأننا نحتاج لتتبع حالة الـ Checkbox
class HealthcarePr extends StatefulWidget {
  HealthcarePr({super.key});
...
class _HealthcarePrState extends State<HealthcarePr> {
  ...
  bool _isTermsAccepted = false; // 👈 متغير لتتبع حالة الموافقة على الشروط
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              CustomToggleButtons(selectedIndex: 1),
              ...
              Transform.translate(
                offset: Offset(15, 5),
                child: Text("Healthcare Provider Information",
                    style: TextStyle(
                        color: Colors.black,
                        fontSize: 14,
                        fontFamily: 'Nunito',
              ...
              UsernameTextField(
                ...
                onArrowPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => Healthcareinformation(),
                    ),
                  );
                },
              ),
